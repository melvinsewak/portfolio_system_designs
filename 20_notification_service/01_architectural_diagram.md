# Notification Service - Architectural Diagram

## Overview
High-level architecture for notification service, designed to handle scalability, reliability, and performance requirements.
