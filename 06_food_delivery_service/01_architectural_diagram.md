# Food Delivery Service - Architectural Diagram

## Overview
High-level architecture for food delivery service, designed to handle scalability, reliability, and performance requirements.
